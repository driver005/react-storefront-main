...
const ProductSlider: React.FC<ProductSliderProps> = ({
  children,
  className = '',
  ButtonbackgroundColor = 'bg-purple-700',
  AlbumbackgroundColor = 'bg-purple-900',
}) => {
  ...
  return (
    <div className={cn(s.root, className)} ref={sliderContainerRef}>
      ...
      >
        {slider && count > 1 && <ProductSliderControl onPrev={onPrev} onNext={onNext} backgroundColor={ButtonbackgroundColor} />}
      ...
      <a.div className={cn(s.album, AlbumbackgroundColor)} ref={thumbsContainerRef}>
        {slider &&
