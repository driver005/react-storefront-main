...
export const CartSummary: React.VFC<CartSummaryProps> = ({ checkout }) => {
  ...
  return (
    <section>
      <div className="bg-transparent p-6 pt-8 ">
        {(editPromoCode || !discount?.amount) && (
          <form className="pb-6" onSubmit={onAddPromoCode}>
            <label
        ...
        <div className="flow-root">
          <dl className="text-sm">
            ...
            <div className="py-2.5 flex items-center justify-between">
              <dt className="text-sm font-medium text-gray-400">Shipping</dt>
              <dd className="font-medium text-gray-900">
                {shippingPrice?.gross.localizedAmount}
              </dd>
            </div>
            <div className="py-2.5 flex items-center justify-between">
              <dt className="text-sm font-medium text-gray-400">Tax</dt>
              <dd className="font-medium text-gray-900">
                {subtotalPrice?.tax.localizedAmount}
              </dd>
            </div>
            <div className="pt-6 mt-6 flex items-center justify-between border-t border-gray-300">
