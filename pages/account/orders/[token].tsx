    ...
    <BaseTemplate>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 mb-20 mt-10 ml-2 md:ml-20 max-w-6xl h-full">
        ...
        {!!order?.billingAddress && (
          <div className="col-span-2 mr-2 my-2 p-4 rounded shadow-xs bg-white border md:w-full md:col-span-2">
        ...
        {!!order?.shippingAddress && (
          <div className="col-span-2 mr-2 md:ml-2 my-2 p-4 shadow-xs rounded bg-white border md:w-full md:col-start-3 md:col-span-2">
